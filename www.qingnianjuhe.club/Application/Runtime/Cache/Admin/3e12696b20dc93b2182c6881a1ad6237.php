                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <?php if(is_array($userList)): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-left"><?php if(($list['distatus'] == 0)): ?>否 <?php elseif(($list['distatus'] == 1 )): ?>审核中<?php endif; ?>
                                        </td>
                                        ...
                                        <td class="text-right">
                                            <a href="<?php echo U('Admin/user/blacklist',array('id'=>$list['user_id']));?>" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="加入黑名单"><i class="fa fa-folder"></i></a>
