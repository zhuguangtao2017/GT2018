...
<body class="" style="background:url(/Public/images/gw_bg.jpg);">
<br><br>
<div class="login-box" style="background-color:white; padding:10px 24px;border:1px solid #CCC;border-radius:10px;">

    <div class="login-logo">
    </div>
    <div class="login-box-body">
        <p class="login-box-msg" style="font-size: 24px;color: #27A9E3;margin-top:-20px;"><strong>后台管理中心</strong></p>
