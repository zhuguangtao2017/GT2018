				        ...
				        <div class="collapse navbar-collapse">
				            <div class="navbar-form row">
								<form class="pull-left" method="post">
									应用模块：<?php if(is_array($module)): foreach($module as $key=>$v): echo ($v["module_name"]); ?> <input type="checkbox" name="module_id[]" value="<?php echo ($v["module_id"]); ?>" <?php if(in_array($v['module_id'],$module_id)): ?>checked="checked"<?php endif; ?>> &nbsp;<?php endforeach; endif; ?>
