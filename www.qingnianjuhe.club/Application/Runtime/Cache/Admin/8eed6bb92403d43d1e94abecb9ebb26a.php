                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" style="font-size:12px;">
                                ...
                                <?php if(is_array($orderList)): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="text-center">
                                        	<input type="checkbox" name="selected[]" value="<?php echo ($list["order_id"]); ?>">
                                        ...
                                        <td class="text-center"><?php echo ($shipping_status[$list[shipping_status]]); if($list['shipping_status'] == 1): if($list['is_comment'] == '0'): ?>(未评价)<?php endif; endif; ?></td>
